...
class parser final {
  ...
  [[nodiscard]] std::unique_ptr<statement_syntax> parse_for_statement();
  [[nodiscard]] std::unique_ptr<statement_syntax> parse_if_statement();
  [[nodiscard]] std::unique_ptr<statement_syntax> parse_while_statement();
