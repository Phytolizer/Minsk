...
void asserting_iterator_init(asserting_iterator_t *iterator,
...
void asserting_iterator_assert_node(asserting_iterator_t *iterator,
                                    syntax_kind_t kind) {
...
void asserting_iterator_assert_token(asserting_iterator_t *iterator,
                                     syntax_kind_t kind, const char *text) {
