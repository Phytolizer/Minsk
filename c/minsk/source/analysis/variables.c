...
static void hash_fnv1a_continue(uint64_t *hash, const void *data,
                                size_t length) {
  uint64_t h = *hash;
  const char *str = data;
...
static variable_map_bucket_t *
variable_map_find_bucket(variable_map_bucket_t *buckets, size_t bucket_count,
